...
class BasePage:
    ...
    def get_text(self, locator):
        return WebDriverWait(self.driver, 6).until(expected_conditions.visibility_of_element_located(locator)).text
    ...
    def get_cookies(self, locator):
        WebDriverWait(self.driver, 6).until(expected_conditions.visibility_of_element_located(locator)).click()
